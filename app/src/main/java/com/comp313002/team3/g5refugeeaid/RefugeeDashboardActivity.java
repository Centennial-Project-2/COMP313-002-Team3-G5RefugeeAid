...
import com.comp313002.team3.g5refugeeaid.databinding.ActivityRefugeeDashboardBinding;
...
public class RefugeeDashboardActivity extends BaseActivity implements  View.OnClickListener {
    ...
    private ActivityRefugeeDashboardBinding mBinding;
    private ValueEventListener mUserListener;
    private String email;

    private List<G5UserData> sponsors;
    private DatabaseReference mUserReference ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBinding = ActivityRefugeeDashboardBinding.inflate(getLayoutInflater());
    ...
    public void onStart() {
        ...
        ValueEventListener userListener = new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                // [START_EXCLUDE]
                Toast.makeText(RefugeeDashboardActivity.this, "Failed to load user.",
    ...
    private void signOut(){
        mAuth.signOut();
        Intent intent = new Intent(RefugeeDashboardActivity.this, MainActivity.class);
